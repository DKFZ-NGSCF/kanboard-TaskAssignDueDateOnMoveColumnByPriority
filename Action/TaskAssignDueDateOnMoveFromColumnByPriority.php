...
/**
 * Set the due date when a task is moved from a specific column based on priority
 *
 * @package Kanboard\Action
 * @author  Lasse Faber
 */
class TaskAssignDueDateOnMoveFromColumnByPriority extends Base
{
    /**
    ...
    {
        return t('Assign a due date when moved from a specific column based on priority');
    }
